...
Anveshak follows a rolling-release model. Only the **latest version** on the `master` branch receives security updates.
...
If you discover a security vulnerability in Anveshak, **please do not open a public GitHub issue**. Instead, report it privately:

1. **GitHub Private Vulnerability Reporting** — Go to the [Security Advisories](https://github.com/samugit83/anveshak/security/advisories) page and click **"Report a vulnerability"**.
...
- Vulnerabilities in Anveshak's own code (webapp, recon orchestrator, agent, MCP servers)
...
Anveshak is an offensive security tool intended for **authorized testing only**. See [DISCLAIMER.md](DISCLAIMER.md) for the full legal disclaimer and acceptable use policy.
