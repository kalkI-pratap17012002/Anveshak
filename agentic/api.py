...
async def lifespan(app: FastAPI):
    ...
    logger.info("Starting Anveshak Agent API...")
    ...
    logger.info("Anveshak Agent API ready (WebSocket)")

    yield

    logger.info("Shutting down Anveshak Agent API...")
    if orchestrator:
        await orchestrator.close()


app = FastAPI(
    title="Anveshak Agent API",
