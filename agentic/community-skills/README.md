...
1. Create your `.md` skill file following the [Writing a Skill File](https://github.com/samugit83/anveshak/wiki/Agent-Skills#writing-a-skill-file) format
2. Test it in your Anveshak instance by uploading via Global Settings
