...
# Anveshak community skill.
BANNED_SHANNONISMS = [
    "save-deliverable",
    ".shannon/",
    "TodoWrite",   # Shannon's task-tracking tool, not exposed to Anveshak agent
    "Task Agent",
    "@include",
...
class TestRegression(unittest.TestCase):
    ...
    def test_wiki_table_includes_new_skill(self):
        wiki = _AGENTIC_DIR.parent / "anveshak.wiki" / "Agent-Skills.md"
        if not wiki.exists():
            self.skipTest("anveshak.wiki not present in this checkout")
