# `ai_surface_target` — Anveshak guinea pig for AI surface recon
...
```
                ...
                └─────────────────────────────────────────┘
                          ...
                          │
                ┌─────────────────────────────────────────┐
                │  Anveshak recon (naabu + nmap + httpx)   │
...
2. Creates a Anveshak project with `ipMode=true`, `targetIps=['127.0.0.1']`, the 18 ports in `naabuCustomPorts`, and the 38 paths in `httpxPaths`.
