"""
Anveshak Terminal Server — WebSocket PTY for Kali Sandbox

Provides a WebSocket endpoint that spawns an interactive bash shell
with full PTY support. Used by the Anveshak Terminal tab in the webapp.
...
async def _run_pty_session(ws):
    ...
    if pid == 0:
        ...
        env["SHELL"] = "/bin/bash"
        env["PS1"] = r"\[\033[1;31m\]anveshak\[\033[0m\]@\[\033[1;36m\]kali\[\033[0m\]:\[\033[1;33m\]\w\[\033[0m\]$ "
