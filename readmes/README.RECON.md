# Anveshak Reconnaissance Module
...
flowchart TB
    subgraph Host["🖥️ HOST MACHINE"]
        ...
        subgraph Containers["Sibling Containers"]
            Recon["anveshak-recon<br/>Python Orchestrator<br/>📋 Coordinates all scans"]
...
sequenceDiagram
    participant User
    participant Recon as anveshak-recon
...
📖 **Detailed documentation:** [readmes/GRAPH.SCHEMA.md — GraphQL-specific Endpoint & Vulnerability properties](GRAPH.SCHEMA.md) | **[Wiki: GraphQL Security Testing](https://github.com/samugit83/anveshak/wiki/GraphQL-Security-Testing)**
...
📖 **Detailed documentation:** [readmes/GRAPH.SCHEMA.md -- VHost/SNI Vulnerability properties + Subdomain/IP enrichment](GRAPH.SCHEMA.md) | **[Wiki: VHost & SNI Enumeration](https://github.com/samugit83/anveshak/wiki/VHost-and-SNI-Enumeration)**
...
Unauthorized scanning is illegal. Anveshak is intended for:
