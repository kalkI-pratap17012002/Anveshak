...
Add **[SKILL_NAME]** (e.g. `ssrf_exploitation`, `xxe_exploitation`, `race_conditions`) as a new **Community Agent Skill** shipped with Anveshak.
...
| 3. Wiki community table | [anveshak.wiki/Agent-Skills.md](../../anveshak.wiki/Agent-Skills.md) "Community Skills" | YES if shipping publicly |
...
Canonical template (follow this shape, the wiki at [anveshak.wiki/Agent-Skills.md](../../anveshak.wiki/Agent-Skills.md) documents it and the Intent Router expects it):
...
Edit the "Community Skills" table in [anveshak.wiki/Agent-Skills.md](../../anveshak.wiki/Agent-Skills.md) (the table around lines 164-169 in the current version).

Add a row matching the existing format:

```markdown
| **[<Display Name>](https://github.com/samugit83/anveshak/blob/master/agentic/community-skills/<skill_name>.md)** | [@<author>](https://github.com/<author>) | <focus area> | <1-2 highlights> |
```
...
- [ ] (Optional, if shipping publicly) [anveshak.wiki/Agent-Skills.md](../../anveshak.wiki/Agent-Skills.md) Community Skills table updated
