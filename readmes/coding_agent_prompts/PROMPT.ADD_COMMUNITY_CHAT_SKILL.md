...
Add **[SKILL_NAME]** (e.g. `ad_kill_chain`, `ffuf`, `jwt_cheatsheet`) as a new **Chat Skill** shipped with Anveshak.
...
| 3. Wiki catalog | [anveshak.wiki/Chat-Skills.md](../../anveshak.wiki/Chat-Skills.md) | YES if shipping publicly |
...
Chat Skills are simpler than Agent Skills. The wiki documents this at [anveshak.wiki/Chat-Skills.md "Writing a Chat Skill File"](../../anveshak.wiki/Chat-Skills.md):
...
Edit the "Default Chat Skills Library" and/or "Community Chat Skills" tables in [anveshak.wiki/Chat-Skills.md](../../anveshak.wiki/Chat-Skills.md) (current tables at lines ~217-235).

Add a row matching the format:

```markdown
| **[<Display Name>](https://github.com/samugit83/anveshak/blob/master/agentic/skills/<category>/<skill_name>.md)** | <Category> | <Focus line> |
```
...
- [ ] (Optional, if shipping publicly) [anveshak.wiki/Chat-Skills.md](../../anveshak.wiki/Chat-Skills.md) catalog table updated
