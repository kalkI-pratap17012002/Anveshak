"""
Anveshak - Katana Crawler Helpers for Resource Enumeration
=========================================================
...
def run_katana_crawler(
    ...
    # Write target URLs to /tmp/anveshak (bind-mounted same path host<->recon
    ...
    os.makedirs("/tmp/anveshak", exist_ok=True)
    url_file = f"/tmp/anveshak/katana_targets_{uuid.uuid4().hex[:8]}.txt"
    ...
    try:
        ...
        cmd.extend(["-v", "/tmp/anveshak:/tmp/anveshak"])
