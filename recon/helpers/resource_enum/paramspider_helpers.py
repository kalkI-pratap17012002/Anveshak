...
def _create_temp_dir() -> Path:
    """Create a temp directory under /tmp/anveshak for ParamSpider output files."""
    temp_dir = Path(f"/tmp/anveshak/.paramspider_{uuid.uuid4().hex[:8]}")
