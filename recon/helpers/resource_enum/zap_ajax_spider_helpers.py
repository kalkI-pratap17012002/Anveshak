"""
Anveshak - ZAP Ajax Spider Helpers for Resource Enumeration
==========================================================
...
def build_zap_ajax_automation_plan(
    ...
    lines.extend([
        '  - type: "replacer"',
        '    name: "anveshak-zap-ajax-headers"',
    ])
    ...
    lines.extend([
        ...
        '    name: "anveshak-zap-passive-scan"',
        "    parameters:",
        f"      maxDuration: {int(max_duration)}",
        '  - type: "export"',
        '    name: "anveshak-zap-ajax-export"',
        "    parameters:",
        f"      context: {q(ZAP_CONTEXT_NAME)}",
        '      type: "url"',
        '      source: "all"',
...
def merge_zap_ajax_into_by_base_url(
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location("anveshak_resource_enum_classification", classification_path)
...
def run_zap_ajax_spider(
    ...
    work_dir = Path(f"/tmp/anveshak/zap_ajax_{uuid.uuid4().hex[:8]}")
