"""
Anveshak - Subdomain Takeover Helpers
====================================
...
#
# AGPL isolation: Anveshak Python never imports baddns. The binary lives
# in its own image (`anveshak-baddns:latest`) with its own filesystem.
...
def build_baddns_command(
    ...
    *,
    ...
    docker_image: str = "anveshak-baddns:latest",
