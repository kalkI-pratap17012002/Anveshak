...
Run all (inside anveshak-recon image which has dns/yaml/etc):
  docker run --rm --entrypoint python3 \\
      -v "$PWD:/app" -w /app anveshak-recon \\
...
class TestSmokeNucleiBehavior(unittest.TestCase):
    ...
    without templates). Inside the anveshak-kali container they all run.
    """
