...
RECON_IMAGE = os.getenv("RECON_IMAGE", "anveshak-recon:latest")
GVM_SCAN_PATH = _get_host_path(_host_mounts, "/app/gvm_scan", "GVM_SCAN_PATH")
GVM_IMAGE = os.getenv("GVM_IMAGE", "anveshak-vuln-scanner:latest")
GITHUB_HUNT_PATH = _get_host_path(_host_mounts, "/app/github_secret_hunt", "GITHUB_HUNT_PATH")
GITHUB_HUNT_IMAGE = os.getenv("GITHUB_HUNT_IMAGE", "anveshak-github-hunter:latest")
TRUFFLEHOG_PATH = _get_host_path(_host_mounts, "/app/trufflehog_scan", "TRUFFLEHOG_PATH")
TRUFFLEHOG_IMAGE = os.getenv("TRUFFLEHOG_IMAGE", "anveshak-trufflehog:latest")
try:
...
app = FastAPI(
    title="Anveshak Recon Orchestrator",
