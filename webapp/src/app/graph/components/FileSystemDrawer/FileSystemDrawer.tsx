...
const WIDTH_STORAGE_KEY = 'anveshak-filesystem-drawer-width'
...
export function FileSystemDrawer({
  ...
  // Anveshak-styled modal dialogs (replaces browser-native alert/confirm).
  ...
  return (
    <Drawer
      ...
      headerActions={
        <WikiInfoButton
          target="https://github.com/samugit83/anveshak/wiki/Agent-Workspace"
