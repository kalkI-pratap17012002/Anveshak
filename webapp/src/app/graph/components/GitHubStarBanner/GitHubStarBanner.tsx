...
const STORAGE_KEY = 'anveshak-github-star-dismissed'
  ...
  return (
    <div className={styles.banner}>
      ...
      <span className={styles.text}>
        Enjoying Anveshak? A <a href="https://github.com/samugit83/anveshak" target="_blank" rel="noopener noreferrer">GitHub star</a> helps others discover the project.
      </span>
