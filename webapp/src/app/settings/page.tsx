...
export default function SettingsPage() {
  ...
  const downloadKeysTemplate = useCallback(() => {
    ...
    const a = document.createElement('a')
    a.href = url
    a.download = 'anveshak-api-keys-template.json'
    a.click()
    URL.revokeObjectURL(url)
    ...
    <div className={styles.page}>
      ...
      {activeTab === 'providers' && <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            ...
            <WikiInfoButton target="https://github.com/samugit83/anveshak/wiki/AI-Model-Providers" title="Open AI Model Providers wiki page" />
          </h2>
      ...
      {activeTab === 'skills' && <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            ...
            <WikiInfoButton target="https://github.com/samugit83/anveshak/wiki/Agent-Skills" title="Open Agent Skills wiki page" />
          </h2>
        ...
        <p className={styles.sectionHint}>
          ...
          {' '}Browse <a href="https://github.com/samugit83/anveshak/wiki/Agent-Skills#community-skills" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--accent-primary)', textDecoration: 'underline' }}>community skills</a> for ready-to-use templates.
        </p>
      ...
      {activeTab === 'chat-skills' && <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            ...
            <WikiInfoButton target="https://github.com/samugit83/anveshak/wiki/Chat-Skills" title="Open Chat Skills wiki page" />
          </h2>
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            <button
              className="secondaryButton"
      ...
      {activeTab === 'tradecraft' && <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle}>
            ...
            <WikiInfoButton target="https://github.com/samugit83/anveshak/wiki/Tradecraft-Lookup" title="Open Tradecraft Lookup wiki page" />
          </h2>
      ...
      <div className={styles.section}>
        <div className={styles.sectionHeader}>
          <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
            <span>Tunneling</span>
            <WikiInfoButton target="https://github.com/samugit83/anveshak/wiki/Reverse-Shells" title="Open Reverse Shells wiki page" />
          </h2>
        </div>
        <p className={styles.sectionHint}>
...
function SystemSection() {
  ...
  const handleCopy = useCallback(() => {
    navigator.clipboard.writeText('./anveshak.sh update').then(() => {
      setCopied(true)
  ...
  return (
    <div className={styles.section}>
      <div className={styles.sectionHeader}>
        <h2 className={styles.sectionTitle} style={{ display: 'inline-flex', alignItems: 'center', gap: '8px' }}>
          <Info size={16} /> System
          <WikiInfoButton target="https://github.com/samugit83/anveshak/wiki/Troubleshooting" title="Open Troubleshooting wiki page" />
        </h2>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', gap: '12px', fontSize: '11px' }}>
          <a
            href="https://github.com/samugit83/anveshak/blob/master/CHANGELOG.md"
            target="_blank"
