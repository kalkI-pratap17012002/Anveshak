        ...
        <div className={styles.card}>
          ...
          <div className={styles.body}>
            <p className={styles.welcomeThank}>
              Thank you for downloading and installing <strong>Anveshak</strong>!
            </p>

            <p className={styles.welcomeDesc}>
              <strong>Anveshak</strong> is an open-source, AI-powered
            ...
            <div className={styles.missionBox}>
              <p className={styles.missionText}>
                Our commitment is to keep Anveshak always up-to-date and make it
            ...
            >
              ...
              <span>Star Anveshak on GitHub</span>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.body}>
          <p className={styles.intro}>
            <strong>Anveshak</strong> is an AI-powered penetration testing
