  ...
  return (
    <div style={{ padding: 'var(--space-3) var(--space-4)', position: 'relative' }}>
      <div style={{ position: 'absolute', top: 8, right: 16 }}>
        <WikiInfoButton target="https://github.com/samugit83/anveshak/wiki/Project-Settings-Reference#social-engineering-simulation" title="Open Social Engineering wiki section" />
      </div>
