              ...
              <div className={styles.fieldGroup}>
                ...
                <div className={styles.toggleRow}>
                  <div>
                    ...
                    <div className={styles.toggleDescription}>
                      Deep DNS analysis across CNAME / NS / MX / TXT / SPF / DMARC / wildcard / NSEC / zone-transfer modules. Runs in its own isolated Docker image (<code style={codeStyle}>anveshak-baddns:latest</code>). Build once with <code style={codeStyle}>docker compose --profile tools build baddns-scanner</code>.
                    </div>
                  </div>
                  <Toggle
