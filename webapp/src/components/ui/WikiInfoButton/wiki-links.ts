...
// Wiki source lives at https://github.com/samugit83/anveshak/wiki and locally at
// `anveshak.wiki/`. Page filenames there map 1:1 to URLs (without the `.md`).

const WIKI_BASE = 'https://github.com/samugit83/anveshak/wiki'
